...
begin
  ...
  if (number_task < 1) or (number_task > Length(Tasks)) then 
    writeln('Задачи с номером', ' ', number_task, ' ', 'не существует')
...
begin
  ...
  begin
    ...
    writeln('Доступные команды: add, list, done, undone, delete, clear, stats, search');
  end;  
